    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/CB_Bots'),
                    InlineKeyboardButton('Feedback', url='https://t.me/CB_Bots/10')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/CB_Bots/9),
